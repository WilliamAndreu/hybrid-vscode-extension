...
exports.generateDomainFiles = generateDomainFiles;
...
function createRequiredDirectories(domainPath, domain) {
    ...
    return Promise.all(directories.map(directory => new Promise((resolve, reject) => {
        try {
            (0, fileUtils_1.createDirectories)(directory);
...
function generateRepositoryFile(outputFile, domain) {
    return new Promise((resolve, reject) => {
        try {
            (0, fileUtils_1.renderTemplateAndWriteFile)("scripts/generate-domain/templates/domain/repositories/repositories.mustache", outputFile, domain);
...
function generateEntityFile(outputFile, domain) {
    return new Promise((resolve, reject) => {
        try {
            (0, fileUtils_1.renderTemplateAndWriteFile)("scripts/generate-domain/templates/domain/entities/entity.mustache", outputFile, domain);
...
function generateUseCaseFile(outputFile, domain) {
    return new Promise((resolve, reject) => {
        try {
            (0, fileUtils_1.renderTemplateAndWriteFile)("scripts/generate-domain/templates/domain/usecases/usecase.mustache", outputFile, domain);
