...
// Función para mostrar las instrucciones de importación del módulo de dominio
...
function showInOutputChannel(channelName, message, clearBeforeShow = false) {
    ...
    // Muestra el canal en el panel Output
    outputChannel.show(true); // El parámetro 'true' fuerza el foco en el panel Output
}
