...
class FrameworkDataProvider {
    ...
    getFrameworks() {
        return [
            ...
            new FrameworkItem_1.FrameworkItem('Ionic', 'Librería para interfaces', vscode.TreeItemCollapsibleState.Collapsed, [
                new FrameworkItem_1.FrameworkItem('Views', 'Gestión de estado', vscode.TreeItemCollapsibleState.None, [], {
                    command: 'rudo.openWebview',
                    title: 'Abrir WebView',
            ...
            new FrameworkItem_1.FrameworkItem('Angular', 'Librería para interfaces', vscode.TreeItemCollapsibleState.Collapsed, [
                new FrameworkItem_1.FrameworkItem('Views', 'Gestión de estado', vscode.TreeItemCollapsibleState.None, [], {
                    command: 'rudo.openWebview',
                    title: 'Abrir WebView',
